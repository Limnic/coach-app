...
import { Flame, Mail, Lock, Eye, EyeOff, ArrowRight, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex">
        ...
        >
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-surface-950 text-surface-500">or continue with</span>
            </div>
          </div>
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-brand-600 via-brand-500 to-coral-500" />
        ...
        <motion.div
          ...
          className="absolute top-20 right-20 w-32 h-32 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20"
        />
        <motion.div
          animate={{ y: [0, 20, 0] }}
          transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }}
          className="absolute bottom-32 left-20 w-24 h-24 rounded-full bg-white/10 backdrop-blur-xl border border-white/20"
        />
        <motion.div
          animate={{ y: [0, -15, 0] }}
          transition={{ duration: 3.5, repeat: Infinity, ease: 'easeInOut' }}
          className="absolute top-1/2 right-40 w-16 h-16 rounded-xl bg-white/10 backdrop-blur-xl border border-white/20"
        />
        ...
        <div className="relative z-10 flex flex-col justify-center p-16">
          ...
          >
            <h2 className="text-5xl font-display font-bold text-white mb-6 leading-tight">
              Scale Your<br />Coaching Business
            </h2>
            <p className="text-xl text-white/80 mb-8 max-w-md">
              Manage unlimited athletes, create custom programs, and deliver personalized coaching at scale.
            </p>
            
            {/* Stats */}
            <div className="flex gap-8">
              <div>
                <p className="text-4xl font-display font-bold text-white">10K+</p>
                <p className="text-white/60">Active Coaches</p>
              </div>
              <div>
                <p className="text-4xl font-display font-bold text-white">500K+</p>
                <p className="text-white/60">Athletes</p>
              </div>
              <div>
                <p className="text-4xl font-display font-bold text-white">98%</p>
